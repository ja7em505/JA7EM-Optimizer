...
**أداة تحسين الألعاب الشاملة — ارفع FPS، نظف جهازك، أصلح ويندوز، وراقب كل شيء بلمسة سايبربانك أسطورية**

![الإصدار](https://img.shields.io/badge/الإصدار-1.0.1-5865F2) ![النظام](https://img.shields.io/badge/النظام-Windows%2010%2F11-00A4EF) ![Electron](https://img.shields.io/badge/Electron-37-green) ![الترخيص](https://img.shields.io/badge/الترخيص-MIT-blue)

> ⚡ أداة واحدة. كل التحسينات. أقصى أداء. أسطورة لا تتوقف. 🎮🔥

![CJ Optimizer](cj-git.png)

> ✨ **رفع FPS حقيقي** • **تنظيف عميق** • **حماية من التلاعب** • **تحديث تلقائي** • **واجهة نيون ساحرة** ✨

---

## 📖 عن الأداة

**CJ Optimizer** ليس مجرد برنامج تحسين... بل **أسطورة سايبربانك** مبنية بتقنية Electron، تمنح اللاعبين والمستخدمين كل ما يحتاجونه ليرفعوا **FPS**، وينظفوا الملفات المؤقتة، ويصلحوا ويندوز، ويراقبوا صحة أجهزتهم — كل ذلك من واجهة واحدة نيون، أنيقة وساحرة وسهلة الاستخدام.
...
# 3️⃣ إنشاء ملف التوكن المطلوب (مهم لتشغيل نظام الترخيص)
echo 'module.exports = "YOUR_GITHUB_TOKEN";' > src/main/license-token.js

# 4️⃣ توليد بصمة السلامة (Integrity Hash)
npm run integrity

# 5️⃣ تشغيل بوضع المطور
npm run dev
```

> ⚠️ **ملاحظة:** ملف `src/main/license-token.js` غير مرفوع على GitHub لأسباب أمنية. أنشئه محلياً قبل التشغيل.
